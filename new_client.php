        ...
        <div class="container-fluid">
            ...
            <?php
                if(isset($_POST['register'])){
                    ...
                    $verificar = "SELECT * FROM clients WHERE carnet_identidad=$carnet";
                    $resultado_consulta1= $conexion->query($verificar);
                    $rows1 = $resultado_consulta1->num_rows; 
                    if($rows1 > 0){
                        echo "  <div class='alert alert-danger' role='alert'>
                                    Ya existe un cliente con ese numero de carnet!
                                </div>";
                    }else{
                        $add_product = "CALL add_cliente($carnet,'$name','$telefono')";
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="addproduct" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="code"  required id="product_code" class="form-control" 
                        id="barcode" placeholder="Carnet  del cliente">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <button type="submit" name="register" class="btn btn-primary">Agregar cliente</button>
                    </div>
                </div>
            </form>
        </div>
