        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="layout_assistant.php">Inicio / Asistente </a>
                </li>
                <li class="breadcrumb-item active">Nuevo Asistente</li>
            </ol>
            <?php
                if(isset($_POST['register'])){
                    ...
                    $verificar = "SELECT * FROM assistant WHERE carnet=$carnet";
                    $resultado_consulta1= $conexion->query($verificar);
                    $rows1 = $resultado_consulta1->num_rows; 
                    if($rows1 > 0){
                        echo "  <div class='alert alert-danger' role='alert'>
                                    Ya existe un asistente con ese numero de carnet!
                                </div>";
                    }else{
                        $add_product = "CALL add_assistant('$name','$telefono',$carnet)";
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="addproduct" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        id="barcode" placeholder="Carnet  del asistente">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <button type="submit" name="register" class="btn btn-primary">Agregar asistente</button>
                    </div>
                </div>
            </form>
        </div>
