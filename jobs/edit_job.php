<?php
  ...
  //id GET JOB
  $id_job = $_GET['id'];
  $result_product = $conexion->query("SELECT * FROM jobs WHERE id =$id_job");
        ...
        <div class="container-fluid">
            ...
            <?php
                if(isset($_POST['register'])){
                    ...
                    $edit_product = "CALL edit_job($id_job,'$job',$public,$middle,$bill)";
                    $ejecutar = $conexion->query($edit_product);

                    echo "<script> window.location = 'edit_job.php?id=$id_job'</script>";
                }
            ?>
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="addproduct" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        id="barcode" placeholder="Nombre/Descripcion de Trabajo" value="<?php echo $row_product['trabajo'];?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        placeholder="Costo de servicio publico" value="<?php echo $row_product['price_public'];?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        placeholder="Costo de Servicio Intermedio" value="<?php echo $row_product['price_middle'];?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        placeholder="Costo de servicio con Factura" value="<?php echo $row_product['price_middle'];?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <button type="submit" name="register" class="btn btn-primary">Modificar Trabajo</button>
                    </div>
                </div>
            </form>
        </div>
