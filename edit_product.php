<?php
  ...
  //id GET PRODUCTO
  $id_product = $_GET['id'];
  $result_product = $conexion->query("SELECT * FROM product WHERE id ='$id_product'");
        ...
        <div class="container-fluid">
            ...
            <?php
                if(isset($_POST['register'])){
                    ...
                    $edit_product = "CALL edit_product($id_product,'$name','$code',$price_in,$price_out,'$unit',$amount)";
                    $ejecutar = $conexion->query($edit_product);

                    echo "<script> window.location = 'edit_product.php?id=$id_product'</script>";
                }
            ?>
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="addproduct" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        id="barcode" placeholder="Codigo  del Producto" value="<?php echo $row_product['code_product'];?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo $row_product['name_product'];?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="price_in" required class="form-control" 
                            value="<?php echo $row_product['precio_entrada'];?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="price_out" required class="form-control"
                            value="<?php echo $row_product['precio_salida'];?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="unit" required class="form-control" id="unit"
                            value="<?php echo $row_product['unidad'];?>" placeholder="Unidad del Producto">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail1" class="col-lg-2 control-label">Inventario inicial:</label>
                    <div class="col-md-6">
                        <input type="text" name="amount" class="form-control" id="inputEmail1"
                            value="<?php echo $row_product['cantidad'];?>" placeholder="Inventario inicial">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <button type="submit" name="register" class="btn btn-primary">Modificar Producto</button>
                    </div>
                </div>
            </form>
        </div>
