<?php
  ...
  //id GET Vehiculo
  $id_product = $_GET['id'];
  $result_product = $conexion->query("SELECT * FROM vehicle WHERE placa ='$id_product'");
        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="layout_vehiculo.php">Inicio / Vehiculos </a>
                </li>
            ...
            <?php
                if(isset($_POST['register'])){
                    ...
                    $edit_product = "CALL edit_vehicle('$id_product','$modelo','$marca','$color')";
                    $ejecutar = $conexion->query($edit_product);

                    echo "<script> window.location = 'edit_vehicle.php?id=$id_product'</script>";
                }
            ?>
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="addproduct" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="placa" id="product_code" class="form-control" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="marca" required class="form-control" id="name" 
                        value="<?php echo $row_product['marca'];?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="modelo"  class="form-control" 
                            value="<?php echo $row_product['modelo'];?>"
                            id="price_in" placeholder="modelo vehiculo">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="color" required class="form-control"
                            value="<?php echo $row_product['color'];?>"
                            id="price_out" placeholder="color vehiculo">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <button type="submit" name="register" class="btn btn-primary">Modificar Vehiculo</button>
                    </div>
                </div>
            </form>
        </div>
