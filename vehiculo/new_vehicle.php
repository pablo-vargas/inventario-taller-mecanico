        ...
        <div class="container-fluid">
            ...
            <?php
                if(isset($_POST['register'])){
                    ...
                    $verificar = "SELECT * FROM vehicle WHERE placa='$placa'";
                    ...
                    if($rows1 > 0){
                        ...
                        $add_product = "CALL add_vehicle('$placa','$modelo','$marca','$color')";
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="addproduct" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="modelo" class="form-control" id="inputEmail1" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="color" class="form-control" id="inputEmail1" 
